...
echo ' <div class="modal-content">
        <div class="modal-header" style="padding:35px 50px;">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4>Suprression Depense</h4>';
     echo'</div>';
     echo'   <div class="modal-body" style="padding:40px 50px;">
          <form  role="form" method="post" action="pont.php">
           <input type="hidden" name="ams" value="PS">
           <input type="hidden" name="id_pt" value="'.$id_pt.'">
           <input type="hidden" name="t_pt" value="'.$pf3.'">';
	       
	      echo '<h2>Voulez-vous supprimer la depense faite le <b class="rouge">'.$date_pt.'</b> ?</h2>';
	      
	echo '<button type="submit" class="btn btn-danger btn-block" name="valider" value="Supprimer">
