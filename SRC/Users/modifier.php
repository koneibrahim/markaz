...
echo '<div class="modal fade" id="pm_Modal" role="dialog">
    <div class="modal-dialog">';
echo ' <div class="modal-content">
        <div class="modal-header" style="padding:35px 50px;">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
   <h4><span class="glyphicon glyphicon-pencil">
   <span class="glyphicon glyphicon-user">Modification Utilisateur</h4>
        </div>
        <div class="modal-body" style="padding:40px 50px;">
          <form  role="form" method="post" action="index.php">
	  ...
	  echo'<div class="form-group">
	  		<tr><td>
              <label for="usrname"><span class="glyphicon glyphicon-user"></span> Login</label>
              <input type="text" class="form-control" id="usrname" name="login" value="'.$login.'">
              </td>
            </div>
            <div class="form-group">
            	<td>
              <label for="pre">Prénom</label>
              <input type="text" class="form-control" id="pr" name="prenom" value="'.$prenom.'">
              </td></tr>
            </div>';
       echo'<div class="form-group">
       		<tr><td>
       		<div class="form-group">
              <label for="psw"><span class="glyphicon glyphicon-eye-open"></span> Mot de passe</label>
              <input type="password" class="form-control" id="psw" name="passwd" value="'.$passwd.'">
              </td>
            </div>
            	<td>
            <label for="n">Nom</label>
              <input type="text" class="form-control" id="n" name="nom" value="'.$nom.'">
              </td></tr>
              
              <tr><td >
       		<div class="form-group">
              <label for="co">Contact</label>
              <input type="text" class="form-control" id="co" name="contact" value="'.$contact.'">
              </td></tr>
            </div>
         ...
         echo'<div class="form-group">
              ...
              <span class="glyphicon glyphicon-eye-open"></span>Vue &nbsp;';
              		if($gid==0){
              echo'<input type="radio"  id="psw" name="gid" value="1">
              &nbsp;
              <span class="glyphicon glyphicon-pencil"></span><span class="glyphicon glyphicon-file"></span>
              Edition<input type="radio"  id="psw" name="gid" checked value="0">';
              		}
              		else{
              	echo'<input type="radio"  id="psw" name="gid" value="1" checked>
              &nbsp;
              <span class="glyphicon glyphicon-pencil"></span><span class="glyphicon glyphicon-file"></span>
              Edition<input type="radio"  id="psw" name="gid"  value="0">';
              		}
