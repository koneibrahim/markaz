...
// =============== Modal Modifier =================
	...
	echo'<div class="form-group">
		<label class="control-label for="motif">Nom classe&nbsp;
		</label>
		<label><input type="text" class="form-control" id="nom_c" name="nom_cl" value="'.$nom_cl.'">
		</label>
	</div>';
	echo'<div class="form-group">
		<label class="control-label  for="mr">Niveau &nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;
		</label>
		<label><input type="text" class="form-control" id="niv" name="niveau" value="'.$niveau.'">
		</label>
		</div>
