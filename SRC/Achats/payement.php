  ...
  echo'<div id="caisse2">';
      ...
      //echo'<th  colspan="5">Action</th>';
       ...
       echo' <td><a href="payement.php?id_cac='.$ligne['id_cac'].
        ...
        echo' <td><a href="payement.php?id_cac='.$ligne['id_cac'].
      	...
      	//	<!-- Modal_pay -->
  	echo'<div class="modal fade" id="pay_mod" role="dialog">
     ...
     echo'<div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><span class="glyphicon glyphicon-usd"> Payement de l\'achat</h4>
        </div>';
     echo'<div class="modal-body">
          ...
          echo'<input type="hidden" name="date_pay" value="'.$date_pay.'">';
          echo'<input type="hidden" name="nom_pro" value="'.$nom_pro.'">';
          echo'<input type="hidden" name="som" value="'.$som.'">';

          	echo'<div class="form-group centre">
	<label class="control-label for="ag">Nom Agent&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><label>
	<input type="text" class="form-control" id="ag"  name="agent" placeholder="Celui qui en caisse" ></label>
	    </div>';
	    
	    		echo'<div class="form-group centre">
	<label class="control-label for="pay">Montant payé&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><label>
	<input type="text" class="form-control" id="pay"  name="somme" value=" " ></label>
	    </div>';
	    
     echo'</div>';
     echo'<div class="modal-footer">
          <button type="submit" class="btn btn-success" name="valider" value="payer"><b>Payé</b> 
          <span class="glyphicon glyphicon-usd"></span>
          </button>
        </div>';
     echo'</form>';
