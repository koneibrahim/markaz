	...
	echo'<div class="modal fade" id="mod_Modal" role="dialog">
      ...
      echo'<div class="modal-content ">
        <div class="modal-header" style="padding:35px 50px;">
          ...
          <h4><span class="glyphicon glyphicon-pencil"></span> Modification de l\'achat </h4>
        </div>';
        echo'<div class="modal-body" style="padding:40px 50px;">
         ...
         echo'<div class="form-group">
		<label class="control-label for="mat">Date &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><label>
		<input type="text" class="form-control" id="mat"  name="date_ac" value="'.$date_ac.'" 
		title="Désactiver" disabled >
		</label>
	</div>';
	echo'<div class="form-group">
		<label class="control-label for="mat">Libellé &nbsp;</label>
		<label>
		<input type="text" class="form-control" id="mat" name="libele" value="'.$libele.'">
		</label>
	</div>';
	echo'<div class="form-group">
		<label class="control-label  for="f">Fournisseur &nbsp;&nbsp;&nbsp;</label>
		<label><select name="id_fo" >';
			while ($ligne=pg_fetch_assoc($lfournisseur2)) {
			   if($ligne['id_fo']==$id_fo)
	echo'<option value="'.$ligne['id_fo'].'" selected>'.$ligne['prenom_f'].'  '.$ligne['nom_f'].'</option>';
		else
	echo'<option value="'.$ligne['id_fo'].'">'.$ligne['prenom_f'].'  '.$ligne['nom_f'].'</option>';
	}
	echo'</select>
