...
//========= <!--Modal Ajouter =======>
	  ...
	  echo'<div class="modal fade" id="myModal">
		...
		<div class="modal-header">
		  <h4 class="modal-title">Faire payement eleve  '.$nom_el.' '.$prenom_el.' </h4>
...
// =============== Modal Modifier =================
	...
	<h4>Modification de payement eleve '.$nom_el.' '.$prenom_el.'</h4>
	</div>
	...
	echo'<div class="form-group">
		...
		<label><input type="text" class="form-control" id="mt" name="montant_p" value="'.$montant_p.'">
		</label>
	</div>';
	echo'<div class="form-group">
